...
| Script | Faz | Fase |
| --- | --- | --- |
| `audio_test.py` | Toca bipes e falas num fone só, com as opções A e B de direção, para testar com ela (`--extra audio`) | 0.5 |
| `gen_audio.py` | Gera os clipes `.wav` de `shared/audio/vocabulario.yaml` com o Piper (`--extra voz`) | 0.5 |
