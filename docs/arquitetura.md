...
| 1 | `core/decide.py` + `state.py` ✅ (menos obstáculo genérico) — falta: `capture/`, `perception/detector`, `AudioEngine` (fila P0–P4), `supervisor/`, `controls/` (teclado), `telemetry/`, `calibrate_camera.py`, `record_session.py`, `label_events.py`, `record_trace.py`, `eval.py`, spike S1 |
